...
urlpatterns = [
    ...
    path('updates/query/', views.updates, name='updates'),
    path('updates/add/', views.update_add, name='update_add'),
    path('<slug:slug>/edit/', views.post_edit, name='post_edit'),
    path('html/save/', views.html_save, name='html_save'),
    path('html/get/', views.get_html, name='get_html'),
    path('html/to/', views.to_html, name='to_html'),
    path('post/find/', views.post_detail_id, name='post_detail_id'),
    path('post/story/', views.get_stories, name='view_story'),
    path('<slug:slug>/comments/', views.comments_post, name='post_comment'),
