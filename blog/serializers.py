...
class PostSerializer(serializers.ModelSerializer):
    ...
    class Meta: 
        ...
        fields = ('title', 'slug', 'updated_on', 'created_on',
                  'status', 'thumnail', 'abstract', 'total_visited', 'eng_ver', 'lang', 'relationship', 'video', 'pdf', 'previous_post', 'next_post', 'topic', 'ava', 'modelLink', 'features', 'static', 'ver', 'authors', 'total_visited')
